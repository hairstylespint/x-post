...
def scrape_trends_from_trends24():
    ...
    try:
        ...
        # Mengambil 1 keyword acak dari 4 teratas
        ...
        # Langsung memilih satu tren secara acak dan mengembalikannya
        selected_trend = random.choice(trends)
        print(f"Tren yang dipilih secara acak: {selected_trend}")
...
if __name__ == "__main__":
    ...
    # Langsung mendapatkan satu tren acak dari fungsi scrape
    selected_trend = scrape_trends_from_trends24()
